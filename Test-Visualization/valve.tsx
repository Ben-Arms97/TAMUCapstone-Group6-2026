...
const MQTT_URL = 'ws://18.119.164.92:8083'; // Note: Check if your broker uses 8083 or 9001 for WebSockets
  ...
  useEffect(() => {
    ...
    client.on('message', (topic, payload) => {
      if (topic === TOPIC && payload.length >= 2) {
        ...
        // Adjust this math if your simulator uses a different encoding!
